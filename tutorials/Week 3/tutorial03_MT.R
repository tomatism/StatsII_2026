...
#When we put Hessian = T we also consider the curvature of the line at the 
# maximum point, thereof it also considers how probable it is that we would 
# get the same beta_value
...
results_pois <- optim(fn=pois_likelihood, 
                      outcome=y_pois, 
                      input=X, 
                      par= c(0,1),
                      hessian=T, 
